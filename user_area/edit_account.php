...
if(isset($_GET['edit_account'])){
    ...
    $user_mobile=$row_fetch['mobile_no'];
}
    if(isset($_POST['user_update'])){
        ...
        //update query
        $update_data="UPDATE `user` SET username='$username',user_email='$user_email',mobile_no=$user_mobile,user_address='$user_address',user_image='$user_image' WHERE user_id=$update_id";
...
<body>
    ...
    <form action="" method="post" enctype="multipart/form-data" class="text-center">
        ...
        <input type="submit" value="Update" class="bg-dark py-2 px-3 border-0 text-white" name="user_update">
    </form>
</body>
</html>